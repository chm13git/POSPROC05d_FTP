...
for arq in `cat /home/operador/grads/cosmo/cosmo${AREA}/invariantes/lista_anta`;do
	...
	if [ -s /home/operador/grads/cosmo/cosmo${AREA}/invariantes/zoom_grad$AREA ];then

		cat /home/operador/grads/cosmo/cosmo${AREA}/invariantes/zoom_grad$AREA >> temp1
