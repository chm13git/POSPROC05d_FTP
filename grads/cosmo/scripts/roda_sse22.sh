...
if [ $# -ne 3 ];then
	...
	echo "Entre com  area (met, sse, sse22, ne, pry ou ant) e o horario de referencia (00 ou 12) e o prognostico (24, 48, 72, ...) !!!"
...
do
	...
	echo str=\"$str\" >> raw.gs
  	cat $arq > temp1
        ...
        if [ $prefixgs == "zoom" ];then
                ...
                DIRARQGIF="/home/operador/grads/gif/cosmo_sse22zoom_$HH"
                DIRCOMGIF="/home/operador/ftp_comissoes/gif/cosmo_sse22zoom_$HH"

                if [ -s /home/operador/grads/cosmo/cosmo${AREA}/invariantes/gradscosmosse22zoom ];then

                        cat /home/operador/grads/cosmo/cosmo${AREA}/invariantes/gradcosmosse22zoom >> temp1
	...
	cat temp2 | sed -e 's|MODELO|Modelo COSMO 2.2km - CHM|g' 								> temp1
