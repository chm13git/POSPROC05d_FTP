...
if ! [ $AREA == "sse" ] && ! [ $AREA == "ne" ] && ! [ $AREA == "pry" ];then
	...
	/home/operador/grads/cosmo/scripts/geractl_progfinal.sh  ${AREA} ${HH} 

fi

echo
echo " Parte que comeca o CORTE VERTICAL."
echo

/home/operador/grads/cosmo/scripts/cortevertical.sh $AREA $HH $dataanalise

echo
echo " Parte que comeca o METEOGRAMA."
echo

/home/operador/grads/cosmo/scripts/meteogramas.sh $AREA $HH $dataanalise
...
for arq in `ls cvert+neb*.gif ${AREAN}_*.gif`;do  
