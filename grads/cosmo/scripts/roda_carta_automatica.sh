...
for arq in `cat /home/operador/grads/cosmo/cosmo${AREA}/invariantes/listaextremos`;do
	...
	if [ -s /home/operador/grads/cosmo/cosmo${AREA}/invariantes/carta_grad$AREA ];then

		cat /home/operador/grads/cosmo/cosmo${AREA}/invariantes/carta_grad$AREA >> temp1
...
#        mv temp2 temp1
	...
	/opt/opengrads/opengrads -lbc "run raw.gs" -g 580x610
