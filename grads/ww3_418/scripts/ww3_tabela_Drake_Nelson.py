...
# Pontos CC Peixoto Entrando por Nelson: 
...
plt.axis('off')
plt.title('Altura Significativa de Onda (m) CHM/WW3/'+MOD+' '+str(cyc)+'Z '+datai+' Nelson',fontsize=9,loc='left')
plt.savefig('Tabela_Drake_'+datai+'_hs_ww3'+mod+'_'+str(cyc)+'_Nelson.png', bbox_inches='tight',dpi=1500)
plt.close('all')
...
tb = plt.table(cellText=cells, rowLabels=pts, colLabels=Hrs, loc='center', cellColours=img.to_rgba(cells), bbox=[0, 0, 1, 0.9])
plt.axis('off')
plt.title('Vento a 10m (n'u'ós) CHM/WW3/'+MOD+' '+str(cyc)+'Z '+datai+' Nelson',fontsize=9,loc='left')
plt.savefig('Tabela_Drake_'+datai+'_wnd10'+mod+''+str(cyc)+'_Nelson.png', bbox_inches='tight',dpi=1500)
plt.close('all')
...
tb = plt.table(cellText=cells, rowLabels=pts, colLabels=Hrs, loc='center', cellColours=img.to_rgba(cells), bbox=[0, 0, 1, 0.9])
plt.axis('off')
plt.title('Per'u'íodo de Pico (seg) CHM/WW3/'+MOD+' '+str(cyc)+'Z '+datai+' Nelson',fontsize=9,loc='left')
plt.savefig('Tabela_Drake_'+datai+'_perpeak_ww3'+mod+'_'+str(cyc)+'_Nelson.png', bbox_inches='tight',dpi=1500)
plt.close('all')
