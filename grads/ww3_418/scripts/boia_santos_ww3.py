...
#                                                              #
#        Ex: ww3_boia_santos.py icon met                       #
#        Ex: ww3_boia_santos.py icon met 2020 12 01            #
#                                                              #
################################################################
...
# Data
if len(sys.argv)==3: # se não entrar com os argumentos da data
...
nc_f     = '{0}/ww3{1}_{2}_{3}00.nc'.format(outdirbck, model, area, datai)
...
#plt.show()
plt.savefig('boia_santos_ww3{0}_{1}.png'.format(model, datai), bbox_inches='tight',dpi=600)
plt.close('all')
