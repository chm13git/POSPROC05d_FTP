...
'set lon 325.1'
plota()
'draw string 4.2 10.3 NATAL'
'draw string 4.2 10.3 lat: -5.75 lon: -34.9 (27km da costa)'
'draw string 4.2 10.3 ref: 'var'.'
...
'draw string 4.2 10.3 lat: 9.50  lon: -57.0'
'draw string 4.2 9.8  ref: 'var'.'
...
'draw string 4.2 10.3 lat: 6.00  lon: -55.09'
'draw string 4.2 9.8  ref: 'var'.'
...
'draw string 4.2 10.3 lat: 26.05  lon: -80.07'
'draw string 4.2 9.8  ref: 'var'.'
...
'draw string 4.2 10.3 lat: 18.33  lon: -72.21'
'draw string 4.2 9.8  ref: 'var'.'
...
'draw string 4.2 10.3 lat: 12.02  lon: -61.45'
'draw string 4.2 9.8  ref: 'var'.'
...
'set lon  286'
plota()
'draw string 4.2 10.3 HAITI lat: 19.0 lon: -74.0 ref: 'var'.'
'printim ONDOGDIR/ww3iapHH/ondograma_HAITI.gif'
'printim ONDOGDIR/ww3iapHH/ondograma_HAITI.jpg'
'printim /home/operador/grads/ww3_418/ww3gfs/ww3iap/ondogramas/scripts/ondograma_HAITI.gif'
'printim /home/operador/grads/ww3_418/ww3gfs/ww3iap/ondogramas/scripts/ondograma_HAITI.jpg'
...
'set lon 330.9'
plota()
'draw string 4.2 10.3 PED_SPA lat: 0.8 lon: -29.1 ref: 'var'.'
...
'set lon 327.6'
plota()
'draw string 4.2 10.3 FERNOR lat: -3.7 lon: -32.4 ref: 'var'.'
...
'set lon 330.6'
plota()
'draw string 4.2 10.3 TRINDADE lat: -20.5 lon: -29.4 ref: 'var'.'
'printim ONDOGDIR/ww3iapHH/ondograma_TRINDADE.gif'
'printim ONDOGDIR/ww3iapHH/ondograma_TRINDADE.jpg'
...
'set lon 304.43'
plota()
'draw string 4.2 10.3 MONTEVIDEU lat: -35.04 lon: -55.57 ref: 'var'.'
...
'set lon 302.82'
plota()
'draw string 4.2 10.3 MARDELPLATA lat: -38.00 lon: -57.18 ref: 'var'.'
...
'set lon  298'
plota()
'draw string 4.2 10.3 DRAKE  lat: -59.0 lon: -62.0 ref: 'var'.'
...
'set lon  302'
plota()
'draw string 4.2 10.3 EACF lat: -62.00 lon: -58.00 ref: 'var'.'
...
'set lon  295'
plota()
'draw string 4.2 10.3 MALVINAS_W lat: -52.0 lon: -65.0 ref: 'var'.'
...
'set lon 308'
plota()
'draw string 4.2 10.3 MALVINAS_E lat: -52.0 lon: -52.0 ref: 'var'.'
...
'set lon 320.4'
plota()
'draw string  4.2 10.3 NW_N_OCE  lat: 7.1 lon: -39.6 ref: 'var'.'
...
'set lon 339.9'
plota()
'draw string  4.2 10.3 NE_N_OCE lat: 7.1 lon: -20.1 ref: 'var'.'
...
'set lon 315'
plota()
'draw string  4.2 10.3 HOTEL lat: 2.6 lon: -45.0 ref: 'var'.'
...
'set lon 324.9'
plota()
'draw string  4.2 10.3 GOLF lat: -2.5 lon: -35.1 ref: 'var'.'
...
'set lon 339.9'
plota()
'draw string  4.2 10.3 S_N_OCEA lat: -10.0 lon: -20.1 ref: 'var'.'
...
'set lon 339.9'
plota()
'draw string  4.2 10.3 N_S_OCEA lat: -19.9 lon: -20.1 ref: 'var'.'
...
'set lon 339.9'
plota()
'draw string 4.2 10.3 SE_S_OCE lat: -34.9 lon: -20.1 ref: 'var'.'
...
'set lon 324.9'
plota()
'draw string 4.2 10.3 SW_S_OCE lat: -34.9 lon: -35.1 ref: 'var'.'
...
'set lon 327.6'
plota()
'draw string  4.2 10.3 FOXTROT lat: -10.0 lon: -32.4 ref: 'var'.'
...
'set lon 324.9'
plota()
'draw string  4.2 10.3 ECHO lat: -17.5 lon: -35.1 ref: 'var'.'
...
'set lon 322.5'
plota()
'draw string  4.2 10.3 DELTA lat: -22.6 lon: -37.5 ref: 'var'.'
...
'set lon 317.4'
plota()
'draw string 4.2 10.3 BRAVO lat: -27.4 lon: -42.6 ref: 'var'.'
...
'set lon 312.6'
plota()
'draw string 4.2 10.3 ALFA lat: -32.5 lon: -47.4 ref: 'var'.'
...
'set lon  348'
plota()
'draw string 4.2 10.3 62029 lat: 49.0 lon: -12.0 ref: 'var'.'
