...
prog=subwrd(str,i)
titulo(i,prog)
titulos1=' Modelo WW3/COSMO - Per. Pico Ondas(seg) - WW3/COSMO Model - Wave Peak Per.(sec)'
titulos(titulos1)
'printim GIFDIR/ww3AREAHH/periopeak_0'prog'.gif gif x770 y800 white'
*'printim /home/operador/ftp_comissoes/gif/ww3AREA_HH/periopeakcosmo_'prog'.gif gif x577 y600 white'
