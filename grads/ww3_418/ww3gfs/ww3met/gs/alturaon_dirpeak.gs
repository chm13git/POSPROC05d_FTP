...
prog=subwrd(str,i)
titulo(i,prog)
titulos1='WW3/GFS Alt. Sig. Ondas(m) e Dir. Pico(s) | Sig. Wave Height(m) and Peak Dir.(s)'
titulos(titulos1)
'printim GIFDIR/ww3AREAHH/ondas_dpeak_'prog'.gif gif x770 y800 white'
'printim /home/operador/ftp_comissoes/gif/ww3AREA_HH/ondas_dpeak_'prog'.gif gif x577 y600 white'
