...
GIFDIR="/home/operador/grads/gif/ww3_418/ww3gfs"
WORKDIR="/home/operador/grads/ww3_418/ww3gfs" # da dpns5a
...
for arq in `cat $WORKDIR/ww3${AREA}/invariantes/lista_mod`
