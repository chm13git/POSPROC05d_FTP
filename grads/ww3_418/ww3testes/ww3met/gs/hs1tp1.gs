...
prog=subwrd(str,i)
titulo(i,prog)
titulos1=' Modelo WW3/GFS - Fluxo de Energia P01 - WW3/GFS Model - Energy Flux'
titulos(titulos1)
'printim GIFDIR/ww3metHH/hs1tp1_'prog'.gif gif x770 y800 white'
...
'set ccols 49 47 45 31 33 35 37 39 53 55 56 57'
 'd smth9(smth9((ptp01*phs01*phs01*0.5)))'
