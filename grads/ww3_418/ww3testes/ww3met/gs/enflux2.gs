...
prog=subwrd(str,i)
titulo(i,prog)
titulos1=' Modelo WW3/GFS - Fluxo de Energia H2T2 - WW3/GFS Model - Energy Flux'
titulos(titulos1)
'printim GIFDIR/ww3metHH/enflux2_'prog'.gif gif x770 y800 white'
...
'set clevs 50 200 350 500 650 800 950 1050 1200 1350 1500 1650 1800 1950 2100'
'set ccols 0 49 47 45 43 31 33 35 37 39 53 55 56 57 58 59  '
 'd smth9(smth9((1/fp)*(1/fp)*hs*hs))'
