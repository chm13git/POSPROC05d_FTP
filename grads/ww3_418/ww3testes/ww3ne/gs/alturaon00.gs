...
prog=subwrd(str,i)
titulo(i,prog)
titulos1=' Modelo WW3/GFS - Alt. Sig. Ondas(m) PH00 - WW3/GFS Model - Sig. Wave Height(m)'
titulos(titulos1)
'printim GIFDIR/ww3neHH/ph00_'prog'.gif gif x770 y800 white'
...
'set arrlab off'
'set arrscl 0.15'
'd skip(cos(pdi00),7);skip(sin(pdi00),7)' 
'set gxout contour'
