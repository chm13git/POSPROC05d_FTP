...
prog=subwrd(str,i)
titulo(i,prog)
titulos1=' Modelo WW3/GFS - Fluxo de Energia P00 - WW3/GFS Model - Energy Flux'
titulos(titulos1)
'printim GIFDIR/ww3neHH/hs0tp0_'prog'.gif gif x770 y800 white'
...
'set ccols 49 47 45 31 33 35 37 39 53 55 56 57'
 'd smth9(smth9((ptp00*phs00*ph00*0.5)))'
...
'set cthick 9'
'set clab masked'
'd smth9(smth9((ptp00*phs00*phs00*0.5)))'
'set line 1 2 4'
