...
if [ "$#" -ne 5 ];then
     echo "Entre com a area (metarea5, antartica), o horario da rodada (00 ou 12), o horario inicial, o horario final e a regiao missilex (metarea5) e drake/zoom (antartica)) !"
     exit 12
fi
...
export PATH=$PATH:/home/wrfdesenv/local/bin:/opt/opengrads:/home/gempak/GEMPAK6.10/os/linux64/bin:.
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/wrfdesenv/local/lib
export NETCDF=/home/wrfdesenv/local
export JASPERLIB=/home/wrfdesenv/local/lib
export JASPERINC=/home/wrfdesenv/local/include
...
case ${NAREA} in
        drake)
        parametros1="^1:|^275:|^276:|^20:|^271:|^279:"
        parametros2="^1:|^275:|^276:|^20:|^271:"
	lonlat="-90,-50,-75,-40"
        ;;
	zoom)
        parametros1="^1:|^275:|^276:|^20:|^271:|^274:|kpds5=71:kpds6=200|kpds5=7:kpds6=4|kpds5=33:kpds6=100|kpds5=34:kpds6=100|kpds5=11:kpds6=100|kpds5=52:kpds6=100|^279:"
        parametros2="^1:|^275:|^276:|^20:|^271:|^274:|kpds5=71:kpds6=200|kpds5=7:kpds6=4|kpds5=33:kpds6=100|kpds5=34:kpds6=100|kpds5=11:kpds6=100|kpds5=52:kpds6=100"
        lonlat="-64,-54,-65,-60.5"
        ;;
	rumosul)
#        parametros1="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:|^279:"
#        parametros2="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:"
	parametros1="^1:|^304:|^305:|^308:"
	parametros2="^1:|^304:|^305:"
	lonlat="-70.00,-10.00,-50.00,-10.00"
	;;
	missilex)
        parametros1="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:|^279:"
        parametros2="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:"
        lonlat="-45.00,-38.00,-27.00,-21.00"
	;;
	aspirantex2)
	parametros1="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:|^279:"
        parametros2="^1:|^275:|^276:|^20:|^271:|^273:|^274:|^313:"
        lonlat="-60.00,-45.00,-40.00,-30.00"
	;;
esac
...
if [ ${HORA} -eq ${HSTART} ];then
	...
	/home/wrfdesenv/local/bin/cdo sub ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_prec${HORA} ${DIRDADOSEXT}/${DADOSDESPREF}${HORAANT}_prec${HORAANT} ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_prec03h
	...
	/home/wrfdesenv/local/bin/cdo merge ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_outras ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_prec03h ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_todas
...
/home/wrfdesenv/local/bin/cdo -f grb sellonlatbox,${lonlat} ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_todas ${DIRDADOSEXT}/${DADOSDESPREF}${HORA}_cut
...
/home/wrfdesenv/local/bin/cdo merge ${DIRDADOSEXT}/${DADOSDESPREF}*_cut ${DIRDADOSEXT}/${DADOSDESGEMP}
#/home/wrfdesenv/local/local2/bin/grib_set -s generatingProcessIdentifier=31 ${DIRDADOSEXT}/${DADOSDESGEMP} ${DIRDADOSEXT}/${DADOSDESPREF}_subcenter31
/home/wrfdesenv/local/bin/grib_set -s generatingProcessIdentifier=31 ${DIRDADOSEXT}/${DADOSDESGEMP} ${DIRDADOSEXT}/${DADOSDESGEMP}_subcenter31
/usr/bin/bzip2 -z -f ${DIRDADOSEXT}/${DADOSDESGEMP}_subcenter31
