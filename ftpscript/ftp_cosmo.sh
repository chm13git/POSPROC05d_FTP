...
dadosdir2="/home/operador/grads/cosmo/cosmo${AREA}"
...
for prog in `echo ${str}`;do
	...
	while [ $flag -eq 1 ];do 
        ...
        if [ $AREA == "ant" ];then
                cp /home/operador/data/cosmo/${AREA2}/data/ventogrib${HH}/lfff*  ${dadosdir2}/ww3_unrot${HH}
        fi
...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH
	...
	/home/operador/grads/auxilio_decisao/scripts/auxilio.sh ${HH} ww3${AREA} # 10out18 Subst 'cosmo' por 'ww3' CFM esperado pelo script
	...
	/home/operador/grads/cosmo/scripts/zygrib_unrot.sh ${AREA} drakefull ${HH} 00 96
else
